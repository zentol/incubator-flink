...
public class CsvReader {
    ...
    /**
     * Configures the delimiter that separates the fields within a row. The comma character ({@code
     * ','}) is used by default.
     *
     ...
     * position in the array is {@code false}. The result contains the fields where the
     * corresponding position in the boolean array is {@code true}. The number of fields in the
     * result is consequently equal to the number of times that {@code true} occurs in the fields
     * array.
     *
     * @param fields The array of flags that describes which fields are to be included and which
     *     not.
     * @return The CSV reader instance itself, to allow for fluent function chaining.
     */
    ...
    /**
     * Configures which fields of the CSV file should be included and which should be skipped. The
     * positions in the string (read from position 0 to its length) define whether the field at the
     * corresponding position in the CSV schema should be included. parser will look at the first
     * {@code n} fields, where {@code n} is the length of the mask string The parser will skip over
     * all fields where the character at the corresponding position in the string is {@code '0'},
     * {@code 'F'}, or {@code 'f'} (representing the value {@code false}). The result contains the
     * fields where the corresponding position in the boolean array is {@code '1'}, {@code 'T'}, or
     * {@code 't'} (representing the value {@code true}).
     *
    ...
    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 1-tuple which
    ...
    public <T0> DataSource<Tuple1<T0>> types(Class<T0> type0) {
        ...
        CsvInputFormat<Tuple1<T0>> inputFormat =
                new TupleCsvInputFormat<Tuple1<T0>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple1<T0>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 2-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1> DataSource<Tuple2<T0, T1>> types(Class<T0> type0, Class<T1> type1) {
        ...
        CsvInputFormat<Tuple2<T0, T1>> inputFormat =
                new TupleCsvInputFormat<Tuple2<T0, T1>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple2<T0, T1>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 3-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2> DataSource<Tuple3<T0, T1, T2>> types(
        ...
        CsvInputFormat<Tuple3<T0, T1, T2>> inputFormat =
                new TupleCsvInputFormat<Tuple3<T0, T1, T2>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple3<T0, T1, T2>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 4-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3> DataSource<Tuple4<T0, T1, T2, T3>> types(
        ...
        CsvInputFormat<Tuple4<T0, T1, T2, T3>> inputFormat =
                new TupleCsvInputFormat<Tuple4<T0, T1, T2, T3>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple4<T0, T1, T2, T3>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 5-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4> DataSource<Tuple5<T0, T1, T2, T3, T4>> types(
        ...
        TupleTypeInfo<Tuple5<T0, T1, T2, T3, T4>> types =
                TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(type0, type1, type2, type3, type4);
        CsvInputFormat<Tuple5<T0, T1, T2, T3, T4>> inputFormat =
                new TupleCsvInputFormat<Tuple5<T0, T1, T2, T3, T4>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple5<T0, T1, T2, T3, T4>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }
    ...
    public <T0, T1, T2, T3, T4, T5> DataSource<Tuple6<T0, T1, T2, T3, T4, T5>> types(
        ...
        CsvInputFormat<Tuple6<T0, T1, T2, T3, T4, T5>> inputFormat =
                new TupleCsvInputFormat<Tuple6<T0, T1, T2, T3, T4, T5>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple6<T0, T1, T2, T3, T4, T5>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 7-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6> DataSource<Tuple7<T0, T1, T2, T3, T4, T5, T6>> types(
        ...
        CsvInputFormat<Tuple7<T0, T1, T2, T3, T4, T5, T6>> inputFormat =
                new TupleCsvInputFormat<Tuple7<T0, T1, T2, T3, T4, T5, T6>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple7<T0, T1, T2, T3, T4, T5, T6>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 8-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7>
        ...
        CsvInputFormat<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>> inputFormat =
                new TupleCsvInputFormat<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 9-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8>
        ...
        CsvInputFormat<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>> inputFormat =
                new TupleCsvInputFormat<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 10-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
            DataSource<Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> types(
                    ...
                    Class<T8> type8,
                    Class<T9> type9) {
        TupleTypeInfo<Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> types =
                TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                        type0, type1, type2, type3, type4, type5, type6, type7, type8, type9);
        CsvInputFormat<Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> inputFormat =
                new TupleCsvInputFormat<Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 11-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
            DataSource<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> types(
                    ...
                    Class<T9> type9,
                    Class<T10> type10) {
        TupleTypeInfo<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> types =
                TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                        type0, type1, type2, type3, type4, type5, type6, type7, type8, type9,
                        type10);
        CsvInputFormat<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> inputFormat =
                new TupleCsvInputFormat<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 12-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
            DataSource<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> types(
                    ...
                    Class<T10> type10,
                    Class<T11> type11) {
        TupleTypeInfo<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> types =
                TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                        type0, type1, type2, type3, type4, type5, type6, type7, type8, type9,
                        type10, type11);
        CsvInputFormat<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> inputFormat =
                new TupleCsvInputFormat<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 13-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
            DataSource<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> types(
                    ...
                    Class<T11> type11,
                    Class<T12> type12) {
        TupleTypeInfo<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> types =
                TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                        type0, type1, type2, type3, type4, type5, type6, type7, type8, type9,
                        type10, type11, type12);
        CsvInputFormat<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> inputFormat =
                new TupleCsvInputFormat<
                        Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(
                        path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 14-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
            DataSource<Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> types(
                    ...
                    Class<T12> type12,
                    Class<T13> type13) {
        TupleTypeInfo<Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> types =
                TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                        type0, type1, type2, type3, type4, type5, type6, type7, type8, type9,
                        type10, type11, type12, type13);
        CsvInputFormat<Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple14<
                                        T0,
                                        ...
                                        T11,
                                        T12,
                                        T13>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>(
                executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 15-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
    ...
    public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
        ...
        CsvInputFormat<Tuple15<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>>
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple15<
                                        T0,
                                        ...
                                        T12,
                                        T13,
                                        T14>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
    ...
    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 16-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple16<
                                        ...
                                        T13,
                                        T14,
                                        T15>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
    ...
    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 17-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple17<
                                        ...
                                        T14,
                                        T15,
                                        T16>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple18<
                                        ...
                                        T15,
                                        T16,
                                        T17>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                Tuple18<
                        T0,
                        ...
                        T15,
                        T16,
                        T17>>(executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 19-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple19<
                                        ...
                                        T16,
                                        T17,
                                        T18>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                Tuple19<
                        T0,
                        ...
                        T16,
                        T17,
                        T18>>(executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 20-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple20<
                                        ...
                                        T17,
                                        T18,
                                        T19>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                Tuple20<
                        T0,
                        ...
                        T17,
                        T18,
                        T19>>(executionContext, inputFormat, types, Utils.getCallLocationName());
    }

    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 21-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple21<
                                        ...
                                        T18,
                                        T19,
                                        T20>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                Tuple21<
                        T0,
    ...
    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 22-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
        ...
        TupleTypeInfo<
                ...
                types =
                        TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                                type0, type1, type2, type3, type4, type5, type6, type7, type8,
                                type9, type10, type11, type12, type13, type14, type15, type16,
                                type17, type18, type19, type20, type21);
        CsvInputFormat<
                        Tuple22<
                                T0,
                                T1,
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple22<
                                        ...
                                        T19,
                                        T20,
                                        T21>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                Tuple22<
                        T0,
    ...
    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 23-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
        ...
        TupleTypeInfo<
                ...
                types =
                        TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                                type0, type1, type2, type3, type4, type5, type6, type7, type8,
                                type9, type10, type11, type12, type13, type14, type15, type16,
                                type17, type18, type19, type20, type21, type22);
        CsvInputFormat<
                        Tuple23<
                                T0,
                                T1,
                ...
                inputFormat =
                        new TupleCsvInputFormat<
                                Tuple23<
                                        ...
                                        T20,
                                        T21,
                                        T22>>(path, types, this.includedMask);
        configureInputFormat(inputFormat);
        return new DataSource<
                Tuple23<
                        T0,
    ...
    /**
     * Specifies the types for the CSV fields. This method parses the CSV data to a 24-tuple which
     * has fields of the specified types. This method is overloaded for each possible length of the
     * tuples to support type safe creation of data sets through CSV parsing.
     *
     * @param type0 The type of CSV field 0 and the type of field 0 in the returned tuple type.
        ...
        TupleTypeInfo<
                ...
                types =
                        TupleTypeInfo.getBasicAndBasicValueTupleTypeInfo(
                                type0, type1, type2, type3, type4, type5, type6, type7, type8,
                                type9, type10, type11, type12, type13, type14, type15, type16,
                                type17, type18, type19, type20, type21, type22, type23);
        CsvInputFormat<
                        Tuple24<
                                T0,
                                T1,
