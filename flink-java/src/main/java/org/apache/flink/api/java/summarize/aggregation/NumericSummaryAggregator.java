 ...
 *
 * <p>Implementation that couldn't be generic for all numbers was pushed to subclasses. For example,
 * there isn't a generic way to calculate min, max, sum, isNan, isInfinite for all numeric types so
...
public abstract class NumericSummaryAggregator<T extends Number>
     ...
     *
     * <p>The algorithm is described in: "Scalable and Numerically Stable Descriptive Statistics in
     * SystemML", Tian et al, International Conference on Data Engineering 2012
     */
