 ...
 */
@Internal
public abstract class MinAggregationFunction<T extends Comparable<T>>
    ...
    private static final class ImmutableMinAgg<U extends Comparable<U>>
    ...
    private static final class MutableMinAgg<
                    U extends Comparable<U> & ResettableValue<U> & CopyableValue<U>>
            extends MinAggregationFunction<U> {
        private static final long serialVersionUID = 1L;
    ...
    public static final class MinAggregationFunctionFactory implements AggregationFunctionFactory {
        ...
        public <T> AggregationFunction<T> createAggregationFunction(Class<T> type) {
            if (Comparable.class.isAssignableFrom(type)) {
                if (ResettableValue.class.isAssignableFrom(type)
