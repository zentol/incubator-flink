...
public class ReduceOperator<IN> extends SingleInputUdfOperator<IN, IN, ReduceOperator<IN>> {
    ...
    @Override
    protected org.apache.flink.api.common.operators.SingleInputOperator<?, IN, ?>
        ...
        if (grouper == null) {
            ...
            UnaryOperatorInformation<IN, IN> operatorInfo =
                    new UnaryOperatorInformation<>(getInputType(), getInputType());
        ...
        if (grouper.getKeys() instanceof SelectorFunctionKeys) {
            ...
            org.apache.flink.api.common.operators.SingleInputOperator<?, IN, ?> po =
                    translateSelectorFunctionReducer(
                            ...
                            getParallelism(),
                            hint);
            ((PlanUnwrappingReduceOperator<?, ?>) po.getInput())
                    .setCustomPartitioner(grouper.getCustomPartitioner());
    ...
    private static <T, K>
        ...
        PlanUnwrappingReduceOperator<T, K> reducer =
                new PlanUnwrappingReduceOperator<>(
                        function, keys, name, inputType, typeInfoWithKey);
