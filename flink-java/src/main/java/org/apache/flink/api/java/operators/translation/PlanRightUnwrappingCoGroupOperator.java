...
public class PlanRightUnwrappingCoGroupOperator<I1, I2, OUT, K>
        extends CoGroupOperatorBase<
                I1, Tuple2<K, I2>, OUT, CoGroupFunction<I1, Tuple2<K, I2>, OUT>> {
    ...
    public PlanRightUnwrappingCoGroupOperator(
        ...
        super(
                ...
                new BinaryOperatorInformation<I1, Tuple2<K, I2>, OUT>(
                        typeInfo1, typeInfoWithKey2, resultType),
                key1,
    ...
    private static final class TupleRightUnwrappingCoGrouper<I1, I2, OUT, K>
        ...
        @Override
        public void coGroup(
                Iterable<I1> records1, Iterable<Tuple2<K, I2>> records2, Collector<OUT> out)
                throws Exception {
