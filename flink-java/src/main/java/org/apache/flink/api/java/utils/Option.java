...
public class Option {
    ...
    /**
     * Define an alternative / short name of the parameter. Only one alternative per parameter is
     * allowed.
     *
     ...
     * @return the updated Option
     * @throws RequiredParametersException if the list of possible values for the parameter is not
     *     empty and the default value passed is not in the list.
     */
