...
public class CrossOperator<I1, I2, OUT>
    ...
    @Override
    protected CrossOperatorBase<I1, I2, OUT, CrossFunction<I1, I2, OUT>> translateToDataFlow(
        ...
        CrossOperatorBase<I1, I2, OUT, CrossFunction<I1, I2, OUT>> po =
                new CrossOperatorBase<I1, I2, OUT, CrossFunction<I1, I2, OUT>>(
                        function,
                        new BinaryOperatorInformation<I1, I2, OUT>(
    ...
    public static final class DefaultCross<I1, I2> extends CrossOperator<I1, I2, Tuple2<I1, I2>> {
        ...
        public DefaultCross(
            ...
            super(
                    input1,
                    input2,
                    new DefaultCrossFunction<I1, I2>(),
         ...
         * {@link
         * org.apache.flink.api.java.operators.CrossOperator.ProjectCross#projectFirst(int...)} and
         * {@link
        ...
        public <OUT extends Tuple> ProjectCross<I1, I2, OUT> projectFirst(
            ...
            return new CrossProjection<I1, I2>(
                            getInput1(), getInput2(), firstFieldIndexes, null, getCrossHint())
                    .projectTupleX();
        }
        ...
        public <OUT extends Tuple> ProjectCross<I1, I2, OUT> projectSecond(
            ...
            return new CrossProjection<I1, I2>(
                            getInput1(), getInput2(), null, secondFieldIndexes, getCrossHint())
                    .projectTupleX();
        }
    }
    ...
    public static final class ProjectCross<I1, I2, OUT extends Tuple>
        ...
        protected ProjectCross(
            ...
            super(
                    input1,
                    input2,
                    new ProjectCrossFunction<I1, I2, OUT>(
                            fields,
                            isFromFirst,
                            returnType
        ...
        @Override
        public CrossOperator<I1, I2, OUT> withForwardedFieldsSecond(
    ...
    public static final class ProjectCrossFunction<T1, T2, R extends Tuple>
        ...
        /**
         * Instantiates and configures a ProjectCrossFunction. Creates output tuples by copying
         * fields of crossed input tuples (or a full input object) into an output tuple.
         *
    ...
    public static final class CrossProjection<I1, I2> {
        ...
        public <T0, T1> ProjectCross<I1, I2, Tuple2<T0, T1>> projectTuple2() {
            ...
            return new ProjectCross<I1, I2, Tuple2<T0, T1>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
        ...
        public <T0, T1, T2> ProjectCross<I1, I2, Tuple3<T0, T1, T2>> projectTuple3() {
            ...
            return new ProjectCross<I1, I2, Tuple3<T0, T1, T2>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
        ...
        public <T0, T1, T2, T3> ProjectCross<I1, I2, Tuple4<T0, T1, T2, T3>> projectTuple4() {
            ...
            return new ProjectCross<I1, I2, Tuple4<T0, T1, T2, T3>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
        ...
        public <T0, T1, T2, T3, T4>
            ...
            return new ProjectCross<I1, I2, Tuple5<T0, T1, T2, T3, T4>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
        ...
        public <T0, T1, T2, T3, T4, T5, T6>
            ...
            return new ProjectCross<I1, I2, Tuple7<T0, T1, T2, T3, T4, T5, T6>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
        ...
        public <T0, T1, T2, T3, T4, T5, T6, T7, T8>
            ...
            return new ProjectCross<I1, I2, Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
        ...
        public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
            ...
            return new ProjectCross<I1, I2, Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>(
                    this.ds1, this.ds2, this.fieldIndexes, this.isFieldInFirst, tType, this, hint);
        }
    ...
    @Internal
    private static final class DefaultCrossFunction<T1, T2>
