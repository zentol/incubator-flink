...
/**
 * This is a generic Aggregator for Value types like StringValue, DoubleValue, etc. This class makes
 * it easy to re-use the implementation of another aggregator.
 *
 * @param <VT> the "Value Type" to aggregate, e.g. DoubleValue, StringValue
 * @param <PT> the "Primitive Type" that "Value Type" can be naturally converted to, e.g.
 *     DoubleValue converts to Double
 * @param <R> the result type of the aggregation, e.g. NumericColumnSummary&lt;Double&gt;
 * @param <A> the underlying primitive Aggregator that does the actual work, e.g.
...
public abstract class ValueSummaryAggregator<VT extends Value, PT, R, A extends Aggregator<PT, R>>
    ...
    public void combine(Aggregator<VT, R> otherSameType) {
        ValueSummaryAggregator<VT, PT, R, A> other =
                (ValueSummaryAggregator<VT, PT, R, A>) otherSameType;
     ...
     *
     * <p>E.g. DoubleValues can easily be converted to Double and could use an underlying
     * Aggregator&lt;Double,?&gt;
     */
    ...
    public static class ShortValueSummaryAggregator
            extends ValueSummaryAggregator<
                    ShortValue, Short, NumericColumnSummary<Short>, ShortSummaryAggregator> {
    ...
    public static class IntegerValueSummaryAggregator
            extends ValueSummaryAggregator<
                    IntValue, Integer, NumericColumnSummary<Integer>, IntegerSummaryAggregator> {
    ...
    public static class LongValueSummaryAggregator
            extends ValueSummaryAggregator<
                    LongValue, Long, NumericColumnSummary<Long>, LongSummaryAggregator> {
    ...
    public static class FloatValueSummaryAggregator
            extends ValueSummaryAggregator<
                    FloatValue, Float, NumericColumnSummary<Float>, FloatSummaryAggregator> {
    ...
    public static class DoubleValueSummaryAggregator
            extends ValueSummaryAggregator<
                    DoubleValue, Double, NumericColumnSummary<Double>, DoubleSummaryAggregator> {
    ...
    public static class BooleanValueSummaryAggregator
            extends ValueSummaryAggregator<
                    BooleanValue, Boolean, BooleanColumnSummary, BooleanSummaryAggregator> {
    ...
    public static class StringValueSummaryAggregator
            extends ValueSummaryAggregator<
                    StringValue, String, StringColumnSummary, StringSummaryAggregator> {
