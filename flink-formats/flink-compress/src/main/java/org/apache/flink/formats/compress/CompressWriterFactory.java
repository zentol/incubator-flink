...
/**
 * A factory that creates for {@link BulkWriter bulk writers} that, when provided with a {@link
 * CompressionCodec}, they compress the data they write. If no codec is provided, the data is
 * written in bulk but uncompressed.
 *
...
public class CompressWriterFactory<IN> implements BulkWriter.Factory<IN> {
    ...
    /**
     * Creates a new CompressWriterFactory using the given {@link Extractor} to assemble either
     * {@link HadoopCompressionBulkWriter} or {@link NoCompressionBulkWriter} based on whether a
     ...
     * @throws IOException
     */
    public CompressWriterFactory<IN> withHadoopCompression(
