 ...
 */
class AnotherDummyFSFileSystem extends FileSystem {
    ...
    AnotherDummyFSFileSystem(Map<String, String> contents) {
    ...
    public FileStatus[] listStatus(final Path f) throws IOException {
        ...
        return new FileStatus[] {new AnotherDummyFSFileStatus(f, data.length)};
    }
