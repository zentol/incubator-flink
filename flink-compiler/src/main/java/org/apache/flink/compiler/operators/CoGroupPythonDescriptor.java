 ...
 * 
 */
public class CoGroupPythonDescriptor extends OperatorDescriptorDual {
	...
	public CoGroupPythonDescriptor(FieldList keys1, FieldList keys2) {
		this(keys1, keys2, null, null);
	}

	public CoGroupPythonDescriptor(FieldList keys1, FieldList keys2, Ordering additionalOrdering1, Ordering additionalOrdering2) {
		super(keys1, keys2);
	...
	public DriverStrategy getStrategy() {
		return DriverStrategy.CO_GROUP_PYTHON;
	}
	...
	public DualInputPlanNode instantiate(Channel in1, Channel in2, TwoInputNode node) {
		...
		return new DualInputPlanNode(node, "CoGroup (" + node.getPactContract().getName() + ")", in1, in2,
				DriverStrategy.CO_GROUP_PYTHON, this.keys1, this.keys2, inputOrders);
	}
