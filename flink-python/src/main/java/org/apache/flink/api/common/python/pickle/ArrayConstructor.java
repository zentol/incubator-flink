...
/**
 * Creates arrays of objects. Returns a primitive type array such as int[] if the objects are ints,
 * etc. Returns an ArrayList if it needs to contain arbitrary objects (such as lists).
 */
