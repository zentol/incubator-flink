...
public class YarnTestUtils {
    ...
    public static YarnClusterDescriptor createClusterDescriptorWithLogging(
        ...
        final Configuration effectiveConfiguration =
                configureLogFile(flinkConfiguration, flinkConfDir);
    ...
    public static Configuration configureLogFile(
            Configuration flinkConfiguration, String flinkConfDir) {
     ...
     */
    public static void generateFilesInDirectory(File directory, Map<String, String> srcFiles)
            throws IOException {
