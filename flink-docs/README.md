...
3. Regenerate the documentation by running `mvn package -Dgenerate-rest-docs -pl flink-docs/flink-docs-generators -am -nsu -DskipTests`
...
The files can be generated by running `mvn package -Dgenerate-config-docs -pl flink-docs/flink-docs-generators -am -nsu -DskipTests`, and can be integrated into the documentation using `{% include generated/<file-name>.html %}`.
