...
public class CoGroupNode extends TwoInputNode {
    ...
    protected SemanticProperties getSemanticPropertiesForLocalPropertyFiltering() {
        ...
        DualInputSemanticProperties origProps =
                ((DualInputOperator<?, ?, ?, ?>) getOperator()).getSemanticProperties();
    ...
    private List<OperatorDescriptorDual> initializeDataProperties(
        ...
        CoGroupDescriptor descr =
                new CoGroupDescriptor(this.keys1, this.keys2, groupOrder1, groupOrder2);
