...
/**
 * This class represents global properties of the data at a certain point in the plan. Global
 * properties are properties that describe data across different partitions, such as whether the
 * data is hash partitioned, range partitioned, replicated, etc.
 */
public class GlobalProperties implements Cloneable {
        ...
        if (obj instanceof GlobalProperties) {
            ...
            return (this.partitioning == other.partitioning)
                    ...
                    && (this.uniqueFieldCombinations == other.uniqueFieldCombinations
                            || (this.uniqueFieldCombinations != null
                                    && this.uniqueFieldCombinations.equals(
    ...
    public String toString() {
        final StringBuilder bld =
                new StringBuilder(
                        "GlobalProperties [partitioning="
                                + partitioning
                                + (this.partitioningFields == null
                                        ? ""
                                        : ", on fields " + this.partitioningFields)
                                + (this.ordering == null
                                        ? ""
                                        : ", with ordering " + this.ordering));
    ...
    public GlobalProperties clone() {
        ...
        newProps.uniqueFieldCombinations =
                this.uniqueFieldCombinations == null
                        ? null
                        : new HashSet<FieldSet>(this.uniqueFieldCombinations);
        return newProps;
    }
