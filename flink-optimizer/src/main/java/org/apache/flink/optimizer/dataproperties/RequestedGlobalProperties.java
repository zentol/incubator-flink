 ...
 *
 * <ul>
 *   <li>"groupBy/reduce" will request the data to be partitioned in some way after the key fields.
 *   <li>"map" will request the data to be in an arbitrary distribution - it has no prerequisites
