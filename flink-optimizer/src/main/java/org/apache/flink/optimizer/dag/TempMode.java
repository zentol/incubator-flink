 ...
 * connection. Introducing such an artificial dam is sometimes necessary to avoid that a certain
 * data flows deadlock themselves, or as a cache to replay an intermediate result.
 */
