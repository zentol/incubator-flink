 ...
 * org.apache.calcite.rel.rules.SemiJoinProjectTransposeRule}. Modification: - Match Join with SEMI
 * or ANTI type instead of SemiJoin - Add predicate to check all expressions in Project should be
 * RexInputRef
 */
