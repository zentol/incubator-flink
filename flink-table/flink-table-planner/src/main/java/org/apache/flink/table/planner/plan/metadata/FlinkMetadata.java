...
public abstract class FlinkMetadata {
    ...
    public interface ColumnInterval extends Metadata {
        ...
        MetadataDef<ColumnInterval> DEF =
    ...
    public interface FilteredColumnInterval extends Metadata {
        ...
        MetadataDef<FilteredColumnInterval> DEF =
                MetadataDef.of(
    ...
    public interface ColumnNullCount extends Metadata {
        ...
        MetadataDef<ColumnNullCount> DEF =
    ...
    public interface ColumnOriginNullCount extends Metadata {
        ...
        MetadataDef<ColumnOriginNullCount> DEF =
                MetadataDef.of(
     ...
     *
     * <p>If you are an operator consuming a relational expression, which subset of the rows are you
     * seeing? You might be seeing all of them (BROADCAST or SINGLETON), only those whose key column
     * values have a particular hash code (HASH) or only those whose column values have particular
     * values or ranges of values (RANGE).
     *
     * <p>When a relational expression is partitioned, it is often partitioned among nodes, but it
     * may be partitioned among threads running on the same node.
     */
    public interface FlinkDistribution extends Metadata {
        ...
        MetadataDef<FlinkDistribution> DEF =
                MetadataDef.of(FlinkDistribution.class, FlinkDistribution.Handler.class, METHOD);
    ...
    /**
     * Metadata about the modified property of a RelNode. For example, an aggregate RelNode contains
     * a max aggregate function whose result value maybe modified increasing.
     */
    public interface ModifiedMonotonicity extends Metadata {
        Method METHOD =
                Types.lookupMethod(ModifiedMonotonicity.class, "getRelModifiedMonotonicity");

        MetadataDef<ModifiedMonotonicity> DEF =
                MetadataDef.of(
                        ModifiedMonotonicity.class, ModifiedMonotonicity.Handler.class, METHOD);
