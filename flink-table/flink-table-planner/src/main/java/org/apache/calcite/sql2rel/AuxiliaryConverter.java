...
/**
 * Converts an expression for a group window function (e.g. TUMBLE) into an expression for an
 * auxiliary group function (e.g. TUMBLE_START).
 *
...
public interface AuxiliaryConverter {
     ...
     * @return Expression for auxiliary function, e.g. "$0 + 36000" converts the result of TUMBLE to
     *     the result of TUMBLE_END
     */
