 ...
 * not provided.
 *
 * <p>The serialized string representation is {@code TIME(p)} where {@code p} is the number of
 * digits of fractional seconds (=precision). {@code p} must have a value between 0 and 9 (both
 * inclusive). If no precision is specified, {@code p} is equal to 0. {@code TIME(p) WITHOUT TIME
 * ZONE} is a synonym for this type.
 *
