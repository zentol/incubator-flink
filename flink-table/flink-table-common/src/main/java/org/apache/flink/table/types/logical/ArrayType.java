 ...
 *
 * <p>The serialized string representation is {@code ARRAY<t>} where {@code t} is the logical type
 * of the contained elements. {@code t ARRAY} is a synonym for being closer to the SQL standard.
 */
@PublicEvolving
