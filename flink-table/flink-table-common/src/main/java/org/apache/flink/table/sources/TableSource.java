 ...
 * of the produced {@link DataType}. An explicit mapping can be defined by implementing the {@link
...
public interface TableSource<T> {
     ...
     * @deprecated Table schema is a logical description of a table and should not be part of the
     *     physical TableSource. Define schema when registering a Table either in DDL or in {@code
