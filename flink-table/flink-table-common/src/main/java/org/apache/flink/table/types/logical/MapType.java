 ...
 *
 * <p>The serialized string representation is {@code MAP<kt, vt>} where {@code kt} is the logical
 * type of the key elements and {@code vt} is the logical type of the value elements.
 */
@PublicEvolving
