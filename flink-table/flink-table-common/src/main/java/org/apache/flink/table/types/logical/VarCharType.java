 ...
 *
 * <p>For enabling type inference of a zero-length character string literal to a variable-length
 * character string, this type does also support {@code n} to be 0. However, this is not exposed
 * through the API.
 *
