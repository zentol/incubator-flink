 ...
 * ensure uniqueness.
 *
 * <p>The serialized string representation is {@code MULTISET<t>} where {@code t} is the logical
 * type of the contained elements. {@code t MULTISET} is a synonym for being closer to the SQL
 * standard.
 *
...
public final class MultisetType extends LogicalType {
    ...
    private static final Set<String> INPUT_OUTPUT_CONVERSION =
            conversionSet(Map.class.getName(), MapData.class.getName());
