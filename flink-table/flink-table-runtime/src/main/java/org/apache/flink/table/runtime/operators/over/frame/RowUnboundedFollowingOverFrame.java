...
/**
 * The row unboundedFollowing window frame calculates frames with the following SQL form: ... ROW
 * BETWEEN [window frame preceding] AND UNBOUNDED FOLLOWING [window frame preceding] ::=
 * [unsigned_value_specification] PRECEDING | CURRENT ROW
 *
