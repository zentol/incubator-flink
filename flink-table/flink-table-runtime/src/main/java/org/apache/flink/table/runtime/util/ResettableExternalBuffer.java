 ...
 *
 * <p>NOTE: Not supports reading while writing. In the face of concurrent modification, the iterator
...
public class ResettableExternalBuffer implements ResettableRowBuffer {
    ...
    public ResettableExternalBuffer(
        ...
        this.binaryRowSerializer =
                serializer instanceof BinaryRowDataSerializer
        ...
        this.rowLength =
                isRowAllInFixedPart ? binaryRowSerializer.getSerializedRowFixedPartLength() : -1;
    ...
    private class InMemoryBuffer implements Closeable {
        ...
        public class InMemoryBufferIterator
                implements MutableObjectIterator<BinaryRowData>, Closeable {
