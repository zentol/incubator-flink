...
public class ConfigurationValidatorUtil {
    ...
    public static void validateOptionalPositiveLongProperty(
            Properties config, String key, String message) {
        if (config.containsKey(key)) {
            try {
    ...
    public static void validateOptionalPositiveDoubleProperty(
            Properties config, String key, String message) {
        if (config.containsKey(key)) {
            try {
    ...
    public static void validateOptionalDateProperty(
