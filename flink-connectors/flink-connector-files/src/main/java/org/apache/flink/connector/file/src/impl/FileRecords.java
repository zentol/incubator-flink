 ...
 *
 * <p>This is essentially a slim wrapper around the {@link BulkFormat.RecordIterator} that only adds
...
public final class FileRecords<T> implements RecordsWithSplitIds<RecordAndPosition<T>> {
    ...
    @Nullable private BulkFormat.RecordIterator<T> recordsForSplitCurrent;
    ...
    public static <T> FileRecords<T> forRecords(
            final String splitId, final BulkFormat.RecordIterator<T> recordsForSplit) {
