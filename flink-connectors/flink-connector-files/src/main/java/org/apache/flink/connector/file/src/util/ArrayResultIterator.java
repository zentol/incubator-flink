...
/**
 * A simple {@link BulkFormat.RecordIterator} that returns the elements of an array, one after the
...
public final class ArrayResultIterator<E> extends RecyclableIterator<E>
    ...
    /**
     * Creates a new, initially empty, {@code ArrayResultIterator}. The iterator calls the given
     * {@code recycler} when the {@link #releaseBatch()} method is called.
     */
