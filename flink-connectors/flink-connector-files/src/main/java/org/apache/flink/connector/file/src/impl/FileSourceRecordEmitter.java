 ...
 *
 * <p>This updates the {@link FileSourceSplit} for every emitted record. Because the {@link
 * FileSourceSplit} points to the position from where to start reading (after recovery), the current
