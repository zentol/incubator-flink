...
from flink.context import RuntimeContext
...
class Function(object):
    ...
    def __init__(self):
        ...
        self._iterator = Iterator.RawIterator(self._connection)
        self._collector = Collector.RawCollector(self._connection)
        self._context = RuntimeContext.RuntimeContext(self._iterator, self._collector)
