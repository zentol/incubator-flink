...
public class ArrayFromTupleTest {
    ...
    public void testUserSpecifiedOrder() throws InstantiationException, IllegalAccessException {
        ...
        String[] expected = {
            testStrings[5], testStrings[3], testStrings[6], testStrings[7], testStrings[0]
        };
        ...
        arrayEqualityCheck(
                expected2, new ArrayFromTuple(0, Tuple.MAX_ARITY - 1).extract(currentTuple));

        String[] expected3 = {testStrings[Tuple.MAX_ARITY - 1], testStrings[0]};
        arrayEqualityCheck(
                expected3, new ArrayFromTuple(Tuple.MAX_ARITY - 1, 0).extract(currentTuple));
