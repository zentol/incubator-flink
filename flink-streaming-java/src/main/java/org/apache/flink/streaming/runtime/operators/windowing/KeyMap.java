 ...
 *
 * <ul>
 *   <li>A different hashing scheme. This implementation uses extensible hashing, meaning that each
 *       hash table growth takes one more lower hash code bit into account, and values that where
