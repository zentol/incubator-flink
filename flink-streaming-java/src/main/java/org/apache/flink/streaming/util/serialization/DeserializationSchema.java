 ...
 * Flink.
 *
 * <p>Note: In most cases, one should start from {@link AbstractDeserializationSchema}, which takes
...
public interface DeserializationSchema<T>
        extends org.apache.flink.api.common.serialization.DeserializationSchema<T>,
                Serializable,
