 ...
 * @deprecated Extend {@link
 *     org.apache.flink.streaming.api.functions.timestamps.AscendingTimestampExtractor} instead.
 */
@PublicEvolving
@Deprecated
public abstract class AscendingTimestampExtractor<T>
        extends org.apache.flink.streaming.api.functions.timestamps.AscendingTimestampExtractor<
                T> {}
