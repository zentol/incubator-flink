 ...
 *
 * @param <OUT> The type of the output array. If out is set to String, the output of the extractor
 *     will be a String[]. If it is set to String[] the output will be String[][].
 */
@Internal
public class FieldsFromArray<OUT> implements Extractor<Object, OUT[]> {
     ...
     * the specified type.
     *
     * @param clazz the Class object representing the component type of the new array
     * @param indexes The indexes of the fields to be extracted. Any order is possible, but not more
     *     than 255 fields due to limitations in {@link Array#newInstance(Class, int...)}.
     */
