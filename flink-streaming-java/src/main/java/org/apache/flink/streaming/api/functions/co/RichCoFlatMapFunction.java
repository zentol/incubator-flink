...
/**
 * A RichCoFlatMapFunction represents a FlatMap transformation with two different input types. In
 * addition to that the user can use the features provided by the {@link RichFunction} interface.
 *
