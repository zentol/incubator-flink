 ...
 * elements of a stream. One of the connected streams has the rules, the other stream the elements
 * to apply the rules to. The operation on the connected stream maintains the current set of rules
 * in the state. It may receive either a rule update (from the first stream) and update the state,
 * or a data element (from the second stream) and apply the rules in the state to the element. The
 * result of applying the rules would be emitted.
 *
