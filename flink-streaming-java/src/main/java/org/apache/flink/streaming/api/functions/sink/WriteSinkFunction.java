...
/**
 * Simple implementation of the SinkFunction writing tuples as simple text to the file specified by
 * path. Tuples are collected to a list and written to the file periodically. The file specified by
 * path is created if it does not exist, cleared if it exists before the writing.
 *
