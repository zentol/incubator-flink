...
public abstract class BaseBroadcastProcessFunction extends AbstractRichFunction {
    ...
    /**
     * A base {@link BaseContext context} available to the broadcasted stream side of a {@link
     ...
     * get and update the elements stored in the {@link BroadcastState broadcast state}. In other
