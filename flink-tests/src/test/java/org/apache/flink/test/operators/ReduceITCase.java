...
public class ReduceITCase extends AbstractTestBase {
    ...
    public void testReduceOnTupleWithMultipleKeyFieldSelectors() throws Exception {
        ...
        DataSet<Tuple5<Integer, Long, Integer, String, Long>> reduceDs =
                ds.groupBy(4, 0)
                        .reduce(
                                (in1, in2) -> {
                                    Tuple5<Integer, Long, Integer, String, Long> out =
                                            new Tuple5<>();
    ...
    private static class GroupReducer1
        ...
        @Override
        public void reduce(Iterable<PojoWithDateAndEnum> values, Collector<String> out)
                throws Exception {
    ...
    private static class Tuple3Reduce implements ReduceFunction<Tuple3<Integer, Long, String>> {
        ...
        public Tuple3<Integer, Long, String> reduce(
                Tuple3<Integer, Long, String> in1, Tuple3<Integer, Long, String> in2)
                throws Exception {
    ...
    private static class CustomTypeReduce implements ReduceFunction<CustomType> {
        ...
        @Override
        public CustomType reduce(CustomType in1, CustomType in2) throws Exception {
