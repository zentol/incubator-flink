...
public class OuterJoinITCase extends AbstractTestBase {
    ...
    private void testLeftOuterJoinOnTuplesWithKeyPositions(JoinHint hint) throws Exception {
        ...
        DataSet<Tuple2<String, String>> joinDs =
                ds1.leftOuterJoin(ds2, hint).where(0).equalTo(0).with(new T3T5FlatJoin());
    ...
    private void testRightOuterJoinOnTuplesWithKeyPositions(JoinHint hint) throws Exception {
        ...
        DataSet<Tuple5<Integer, Long, Integer, String, Long>> ds2 =
                CollectionDataSets.getSmall5TupleDataSet(env);
        DataSet<Tuple2<String, String>> joinDs =
                ds1.rightOuterJoin(ds2, hint).where(1).equalTo(1).with(new T3T5FlatJoin());
    ...
    private void testFullOuterJoinOnTuplesWithKeyPositions(JoinHint hint) throws Exception {
        ...
        DataSet<Tuple5<Integer, Long, Integer, String, Long>> ds2 =
                CollectionDataSets.getSmall5TupleDataSet(env);
        DataSet<Tuple2<String, String>> joinDs =
                ds1.fullOuterJoin(ds2, hint).where(0).equalTo(2).with(new T3T5FlatJoin());
    ...
    public void testJoinOnTuplesWithCompositeKeyPositions() throws Exception {
        ...
        DataSet<Tuple5<Integer, Long, Integer, String, Long>> ds2 =
                CollectionDataSets.getSmall5TupleDataSet(env);
        DataSet<Tuple2<String, String>> joinDs =
                ds1.fullOuterJoin(ds2).where(0, 1).equalTo(0, 4).with(new T3T5FlatJoin());
        ...
        DataSet<
                ...
                joinDs =
                        ds1.fullOuterJoin(ds2)
                                .where("f0.f0")
                                .equalTo(
                                        "f0.f0") // key is now Integer from Tuple2<Integer, Integer>
                                .with(
                                        new ProjectBothFunction<
                                                Tuple2<Tuple2<Integer, Integer>, String>,
                                                Tuple2<Tuple2<Integer, Integer>, String>>());
    ...
    private static class T3T5FlatJoin
        ...
        public void join(
            ...
            out.collect(
                    new Tuple2<>(
                            first == null ? null : first.f2, second == null ? null : second.f3));
        }
    }
    ...
    private static class T3T5BCJoin
        ...
        public void join(
            ...
            out.collect(
                    new Tuple3<>(
                            first == null ? null : first.f2,
                            second == null ? null : second.f3,
                            broadcast));
        }
    }
    ...
    private static class T3CustJoin
        ...
        public Tuple2<String, String> join(Tuple3<Integer, Long, String> first, CustomType second) {
            ...
            return new Tuple2<>(
                    first == null ? null : first.f2, second == null ? null : second.myString);
        }
    }
    ...
    private static class CustT3Join
        ...
        public Tuple2<String, String> join(CustomType first, Tuple3<Integer, Long, String> second) {
            ...
            return new Tuple2<>(
                    first == null ? null : first.myString, second == null ? null : second.f2);
        }
    }
