 ...
 * preserve the grouping key in the partial result, so that we can do a reduceGroup afterwards to
 * finalize the results for verification. In addition, we can use hashPartition to partition the
 * data and check if no shuffling (just combining) has been performed.
 */
...
public class GroupCombineITCase extends MultipleProgramsTestBase {
    ...
    public void testPartialReduceWithIdenticalInputOutputType() throws Exception {
        ...
        List<Tuple3<Integer, Long, String>> result =
                dsWrapped
                        ...
                        .map(
                                new MapFunction<
                                        Tuple2<Long, Tuple3<Integer, Long, String>>,
                                        Tuple3<Integer, Long, String>>() {
                                    @Override
                                    public Tuple3<Integer, Long, String> map(
                                            Tuple2<Long, Tuple3<Integer, Long, String>> value)
                                            throws Exception {
                                        return value.f1;
                                    }
                                })
    ...
    public void testPartialReduceWithDifferentInputOutputType() throws Exception {
        ...
        List<Tuple2<Integer, Long>> result =
                dsWrapped
                        .groupBy(0)
                        // reduce partially
                        ...
                        .map(
                                new MapFunction<
                                        ...
                                        Tuple2<Integer, Long>>() {
                                    @Override
                                    public Tuple2<Integer, Long> map(
                                            Tuple2<Long, Tuple2<Integer, Long>> value)
                                            throws Exception {
                                        return value.f1;
                                    }
                                })
    ...
    public void testCheckPartitionShuffleGroupBy() throws Exception {
        ...
        List<Tuple2<Long, Integer>> result =
                partitionedDS
                        .combineGroup(
                                new GroupCombineFunction<
                                        Tuple3<Integer, Long, String>, Tuple2<Long, Integer>>() {
                                    @Override
                                    public void combine(
        ...
        String[] localExpected =
                new String[] {"(6,6)", "(5,5)" + "(4,4)", "(3,3)", "(2,2)", "(1,1)"};
    ...
    public void testAPI() throws Exception {
        ...
        ds.groupBy(0)
                .combineGroup(new GroupCombineFunctionExample())
                .output(new DiscardingOutputFormat<Tuple1<String>>());
    ...
    private static class GroupCombineFunctionExample
        ...
        @Override
        public void combine(Iterable<Tuple1<String>> values, Collector<Tuple1<String>> out)
                throws Exception {
    ...
    public static class ScalaGroupCombineFunctionExample
            implements GroupCombineFunction<scala.Tuple1<String>, scala.Tuple1<String>> {

        @Override
        public void combine(
                Iterable<scala.Tuple1<String>> values, Collector<scala.Tuple1<String>> out)
                throws Exception {
    ...
    private static class Tuple3toTuple3GroupReduce
        ...
        @Override
        public void combine(
                Iterable<Tuple2<Long, Tuple3<Integer, Long, String>>> values,
                Collector<Tuple2<Long, Tuple3<Integer, Long, String>>> out)
                throws Exception {
            int i = 0;
            long l = 0;
            long key = 0;
    ...
    private static class Tuple3toTuple2GroupReduce
        ...
        public void combine(
                Iterable<Tuple2<Long, Tuple3<Integer, Long, String>>> values,
                Collector<Tuple2<Long, Tuple2<Integer, Long>>> out)
                throws Exception {
            int i = 0;
            long l = 0;
            long key = 0;
        ...
        @Override
        public void reduce(
                Iterable<Tuple2<Long, Tuple2<Integer, Long>>> values,
                Collector<Tuple2<Long, Tuple2<Integer, Long>>> out)
                throws Exception {
    ...
    private static class Tuple2toTuple2GroupReduce
            implements KvGroupReduce<
                    Long, Tuple2<Integer, Long>, Tuple2<Integer, Long>, Tuple2<Integer, Long>> {
    ...
    private class Tuple3KvWrapper
            implements MapFunction<
                    Tuple3<Integer, Long, String>, Tuple2<Long, Tuple3<Integer, Long, String>>> {
        @Override
        public Tuple2<Long, Tuple3<Integer, Long, String>> map(Tuple3<Integer, Long, String> value)
                throws Exception {
            return new Tuple2<>(value.f1, value);
        }
    }

    private interface CombineAndReduceGroup<IN, INT, OUT>
            extends GroupCombineFunction<IN, INT>, GroupReduceFunction<INT, OUT> {}

    private interface KvGroupReduce<K, V, INT, OUT>
