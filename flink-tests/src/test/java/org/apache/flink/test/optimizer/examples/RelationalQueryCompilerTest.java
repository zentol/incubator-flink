...
public class RelationalQueryCompilerTest extends CompilerTestBase {
    ...
    /**
     * Checks if any valid plan is produced. Hash joins are expected to build the orders side, as
     * the statistics indicate this to be the smaller one.
     */
    @Test
    ...
    public static Plan tpch3(String[] args) throws Exception {
        ...
        DataSet<Tuple5<Long, String, String, String, Integer>> orders =
                env.readCsvFile(args[1])
                        .fieldDelimiter("|")
                        .lineDelimiter("\n")
                        .includeFields("101011001")
                        .types(Long.class, String.class, String.class, String.class, Integer.class)
                        .name(ORDERS);
    ...
    private static class FilterO
            implements FlatMapFunction<
                    Tuple5<Long, String, String, String, Integer>, Tuple2<Long, Integer>> {
        @Override
        public void flatMap(
                Tuple5<Long, String, String, String, Integer> value,
    ...
    private static class JoinLiO
            implements FlatJoinFunction<
                    Tuple2<Long, Integer>, Tuple2<Long, Double>, Tuple3<Long, Integer, Double>> {
        @Override
        public void join(
                Tuple2<Long, Integer> first,
                Tuple2<Long, Double> second,
                Collector<Tuple3<Long, Integer, Double>> out)
                throws Exception {
            // not going to be executed
        }
    }
    ...
    private static class AggLiO
            implements GroupReduceFunction<
                            Tuple3<Long, Integer, Double>, Tuple3<Long, Integer, Double>>,
                    GroupCombineFunction<
                            Tuple3<Long, Integer, Double>, Tuple3<Long, Integer, Double>> {
        @Override
        public void reduce(
                Iterable<Tuple3<Long, Integer, Double>> values,
                Collector<Tuple3<Long, Integer, Double>> out)
                throws Exception {
            // not going to be executed
        }
