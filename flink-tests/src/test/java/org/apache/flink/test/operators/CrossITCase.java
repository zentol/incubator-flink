...
public class CrossITCase extends AbstractTestBase {
    ...
    private static class CustomTypeCross
            implements CrossFunction<CustomType, CustomType, CustomType> {

        private static final long serialVersionUID = 1L;

        @Override
        public CustomType cross(CustomType first, CustomType second) throws Exception {

            return new CustomType(
                    first.myInt * second.myInt,
                    first.myLong + second.myLong,
                    first.myString + second.myString);
        }
    }
    ...
    private static class MixedCross
        ...
        public Tuple3<Integer, Long, String> cross(
                Tuple5<Integer, Long, Integer, String, Long> first, CustomType second)
                throws Exception {

            return new Tuple3<Integer, Long, String>(
                    first.f0 + second.myInt, first.f2 * second.myLong, first.f3 + second.myString);
        }
    }
    ...
    private static class Tuple5CrossBC
        ...
        public Tuple3<Integer, Integer, Integer> cross(
            ...
            return new Tuple3<Integer, Integer, Integer>(
                    first.f0 + second.f0, first.f2 * second.f2, broadcast);
        }
    }
}
