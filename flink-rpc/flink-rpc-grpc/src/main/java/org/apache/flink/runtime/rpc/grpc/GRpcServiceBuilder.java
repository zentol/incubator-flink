...
public class GRpcServiceBuilder implements RpcSystem.RpcServiceBuilder {
    @Override
    public RpcSystem.RpcServiceBuilder withComponentName(String name) {
        return null;
    }

    @Override
    public RpcSystem.RpcServiceBuilder withBindAddress(String bindAddress) {
        return null;
    }

    @Override
    public RpcSystem.RpcServiceBuilder withBindPort(int bindPort) {
        return null;
    }
