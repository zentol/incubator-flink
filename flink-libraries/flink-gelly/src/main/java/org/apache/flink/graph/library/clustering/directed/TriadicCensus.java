...
public class TriadicCensus<K extends Comparable<K> & CopyableValue<K>, VV, EV>
    ...
    public Result getResult() {
        ...
        BigInteger vertexCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "vc"));
        BigInteger unidirectionalEdgeCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "uec") / 2);
        BigInteger bidirectionalEdgeCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "bec") / 2);
        BigInteger triplet021dCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "021d"));
        BigInteger triplet021uCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "021u"));
        BigInteger triplet021cCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "021c"));
        BigInteger triplet111dCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "111d"));
        BigInteger triplet111uCount =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "111u"));
        BigInteger triplet201Count =
                BigInteger.valueOf(vertexDegreesHelper.<Long>getAccumulator(env, "201"));

        // triads with three connecting edges = closed triplet = triangle
        BigInteger triangle030tCount =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "030t"));
        BigInteger triangle030cCount =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "030c"));
        BigInteger triangle120dCount =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "120d"));
        BigInteger triangle120uCount =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "120u"));
        BigInteger triangle120cCount =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "120c"));
        BigInteger triangle210Count =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "210"));
        BigInteger triangle300Count =
                BigInteger.valueOf(triangleListingHelper.<Long>getAccumulator(env, "300"));
     ...
     * @param <T> ID type
     */
    private static class VertexDegreesHelper<T> extends AnalyticHelper<Vertex<T, Degrees>> {
    ...
    public static class Result implements PrintableResult {
        ...
        public Result(BigInteger... counts) {
            Preconditions.checkArgument(
                    counts.length == 16, "Expected 16 counts but received " + counts.length);
         ...
         * among the vertices, forming an open triplet; the unidirectional edge targets the center
         * vertex.
         *
         ...
         * among the vertices, forming an open triplet; the unidirectional edge sources the center
         * vertex.
         *
         ...
         * forming a closed triplet, a triangle; the three unidirectional edges both source and
         * target different vertices.
         *
        ...
        /**
         * Get the count of "120d" triads which have two unidirectional edges and one bidirectional
         * edge among the vertices, forming a closed triplet, a triangle; both unidirectional edges
         * source the same vertex.
         *
         ...
         * among the vertices, forming a closed triplet, a triangle; both unidirectional edges
         * target the same vertex.
         *
        ...
        /**
         * Get the count of "120c" triads which have two unidirectional edges and one bidirectional
         * edge among the vertices, forming a closed triplet, a triangle; one vertex is sourced by
         * and targeted by the unidirectional edges.
         *
        ...
        /**
         * Get the count of "210" triads which have one unidirectional edge and two bidirectional
         * edges among the vertices, forming a closed triplet, a triangle.
         *
         ...
         *
         * <p>The order of the counts is from least to most connected: 003, 012, 102, 021d, 021u,
        ...
        public String toPrintableString() {
            ...
            return "003: "
                    + nf.format(getCount003())
                    + "; 012: "
                    + nf.format(getCount012())
                    + "; 102: "
                    + nf.format(getCount102())
                    + "; 021d: "
                    + nf.format(getCount021d())
                    + "; 021u: "
                    + nf.format(getCount021u())
                    + "; 021c: "
                    + nf.format(getCount021c())
                    + "; 111d: "
                    + nf.format(getCount111d())
                    + "; 111u: "
                    + nf.format(getCount111u())
                    + "; 030t: "
                    + nf.format(getCount030t())
                    + "; 030c: "
                    + nf.format(getCount030c())
                    + "; 201: "
                    + nf.format(getCount201())
                    + "; 120d: "
                    + nf.format(getCount120d())
                    + "; 120u: "
                    + nf.format(getCount120u())
                    + "; 120c: "
                    + nf.format(getCount120c())
                    + "; 210: "
                    + nf.format(getCount210())
                    + "; 300: "
                    + nf.format(getCount300());
        }
