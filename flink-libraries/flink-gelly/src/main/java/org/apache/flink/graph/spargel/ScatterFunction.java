...
public abstract class ScatterFunction<K, VV, Message, EV> implements Serializable {
     ...
     *
     * <p>If the {@link EdgeDirection} is ALL, then this iterator contains both outgoing and
     * incoming edges.
     *
     ...
     * This method is mutually exclusive to the method {@link #getEdges()} and may be called only
     * once.
     *
