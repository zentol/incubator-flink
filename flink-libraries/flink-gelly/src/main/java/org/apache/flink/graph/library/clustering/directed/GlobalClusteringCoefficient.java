...
/**
 * The global clustering coefficient measures the connectedness of a graph. Scores range from 0.0
 * (no triangles) to 1.0 (complete graph).
 *
...
public class GlobalClusteringCoefficient<K extends Comparable<K> & CopyableValue<K>, VV, EV>
    ...
    public static class Result implements PrintableResult {
        ...
        /**
         * Get the global clustering coefficient score. This is computed as the number of closed
         * triplets (triangles) divided by the total number of triplets.
         *
         * <p>A score of {@code Double.NaN} is returned for a graph of isolated vertices for which
        ...
        @Override
        public int hashCode() {
            return new HashCodeBuilder().append(tripletCount).append(triangleCount).hashCode();
        }
