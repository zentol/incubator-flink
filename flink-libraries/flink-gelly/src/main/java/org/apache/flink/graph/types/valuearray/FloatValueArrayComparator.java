...
public class FloatValueArrayComparator extends TypeComparator<FloatValueArray> {
    ...
    public int compareToReference(TypeComparator<FloatValueArray> referencedComparator) {
        int comp =
                ((FloatValueArrayComparator) referencedComparator).reference.compareTo(reference);
    ...
    public void putNormalizedKey(
            FloatValueArray record, MemorySegment target, int offset, int numFloats) {
    ...
    @Override
    public void writeWithKeyNormalization(FloatValueArray record, DataOutputView target)
            throws IOException {
        throw new UnsupportedOperationException();
    }

    @Override
    public FloatValueArray readWithKeyDenormalization(FloatValueArray reuse, DataInputView source)
            throws IOException {
        throw new UnsupportedOperationException();
    }
}
