...
public abstract class GatherFunction<VV, EV, M> implements Serializable {
    ...
    /**
     * This method is invoked once per superstep, for each {@link Neighbor} of each Vertex in the
     * beginning of each superstep in a {@link GatherSumApplyIteration}. It needs to produce a
     * partial value, which will be combined with other partial value in the next phase of the
     * iteration.
     *
     * @param neighbor the input Neighbor. It provides access to the source Vertex and the Edge
     *     objects.
     ...
     * available on all parallel instances of a function.
     *
