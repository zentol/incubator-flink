...
public class MapVerticesITCase extends AbstractTestBase {
    ...
    public void testWithCustomParametrizedType() throws Exception {
        ...
        DataSet<Vertex<Long, DummyCustomParameterizedType<Double>>> mappedVertices =
                graph.mapVertices(new ToCustomParametrizedTypeMapper()).getVertices();
    ...
    private static final class ToTuple1Mapper
            implements MapFunction<Vertex<Long, Long>, Tuple1<Long>> {
    ...
    private static final class ToCustomTypeMapper
            implements MapFunction<Vertex<Long, Long>, DummyCustomType> {
    ...
    private static final class ToCustomParametrizedTypeMapper
            implements MapFunction<Vertex<Long, Long>, DummyCustomParameterizedType<Double>> {
