...
public class IntValueArraySerializerTest extends ValueArraySerializerTestBase<IntValueArray> {
    ...
    protected IntValueArray[] getTestData() {
        int defaultElements =
                IntValueArray.DEFAULT_CAPACITY_IN_BYTES / IntValueArray.ELEMENT_LENGTH_IN_BYTES;
