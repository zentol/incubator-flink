...
public class GraphCreationWithMapperITCase extends AbstractTestBase {
    ...
    public void testWithTuple2ValueMapper() throws Exception {
         ...
         */
        final ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
        Graph<Long, Tuple2<Long, Long>, Long> graph =
                Graph.fromDataSet(
                        TestGraphUtils.getLongLongEdgeData(env),
                        new AssignTuple2ValueMapper(),
                        env);
    ...
    public void testWithConstantValueMapper() throws Exception {
        ...
        Graph<String, Double, Long> graph =
                Graph.fromDataSet(
                        TestGraphUtils.getStringLongEdgeData(env),
                        new AssignDoubleConstantMapper(),
                        env);
    ...
    public void testWithDCustomValueMapper() throws Exception {
         ...
         */
        final ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
        Graph<Long, DummyCustomType, Long> graph =
                Graph.fromDataSet(
                        TestGraphUtils.getLongLongEdgeData(env),
                        new AssignCustomValueMapper(),
                        env);
    ...
    @SuppressWarnings("serial")
    private static final class AssignTuple2ValueMapper
    ...
    @SuppressWarnings("serial")
    private static final class AssignCustomValueMapper
            implements MapFunction<Long, DummyCustomType> {
