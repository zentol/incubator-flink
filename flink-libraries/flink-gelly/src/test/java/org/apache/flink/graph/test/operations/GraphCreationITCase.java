...
public class GraphCreationITCase extends MultipleProgramsTestBase {
    ...
    public void testCreateWithMapper() throws Exception {
        ...
        Graph<Long, Long, Long> graph =
                Graph.fromDataSet(
                        TestGraphUtils.getLongLongEdgeData(env), new AssignIdAsValueMapper(), env);
    ...
    public void testCreateWithCustomVertexValue() throws Exception {
        ...
        Graph<Long, DummyCustomParameterizedType<Double>, Long> graph =
                Graph.fromDataSet(
                        ...
                        new AssignCustomVertexValueMapper(),
                        env);
    ...
    @SuppressWarnings("serial")
    private static final class AssignCustomVertexValueMapper
            implements MapFunction<Long, DummyCustomParameterizedType<Double>> {
