...
public class GridGraph extends GeneratedGraph {
    ...
    protected long vertexCount() {
        ...
        if (vertexCount.compareTo(BigInteger.valueOf(Long.MAX_VALUE)) > 0) {
            throw new ProgramParametrizationException(
                    "Number of vertices in grid graph '"
                            + vertexCount
    ...
    public Graph<LongValue, NullValue, NullValue> create(ExecutionEnvironment env) {
        org.apache.flink.graph.generator.GridGraph graph =
                new org.apache.flink.graph.generator.GridGraph(env);
    ...
    /**
     * Stores and parses the size and endpoint wrapping configuration for a {@link
     * org.apache.flink.graph.generator.GridGraph} dimension.
     */
    private static class Dimension {
        ...
        /**
         * Configuration string to be parsed. The size integer and endpoint wrapping boolean must be
