...
/**
 * A transform is executed both before and after algorithm execution. Multiple transforms may be
 * applied and the order of execution is as listed by the input then algorithm components. The input
 * is transformed in given order and the algorithm result is transformed in reverse order.
 *
