 ...
 *
 * <p>It is an implementation of the Single-Source-Shortest-Paths algorithm. For a scatter-gather
 * implementation of the same algorithm, please refer to {@link SingleSourceShortestPaths} and for a
 * gather-sum-apply implementation see {@link GSASingleSourceShortestPaths}.
 *
...
public class PregelSSSP implements ProgramDescription {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Graph<Long, Double, Double> result =
                graph.runVertexCentricIteration(
                        new SSSPComputeFunction(srcVertexId), new SSSPCombiner(), maxIterations);
    ...
    /**
     * The messages combiner. Out of all messages destined to a target vertex, only the minimum
    ...
    private static boolean parseParameters(String[] args) {
        ...
        if (args.length > 0) {
            if (args.length != 4) {
                System.err.println(
                        "Usage: PregelSSSP <source vertex id>"
            ...
            System.out.println(
                    "Executing Pregel Single Source Shortest Paths example "
