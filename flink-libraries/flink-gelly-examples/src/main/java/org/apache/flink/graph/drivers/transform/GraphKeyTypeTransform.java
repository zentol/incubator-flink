...
/**
 * Transform the ID type of graphs from {@link LongValue} to byte, short, char, integer, float,
 * double, or string. Both boxed Java types and Flink {@link org.apache.flink.types.Value} types are
 * supported. The result is transformed when necessary to standardize {@code hashCode}.
 */
public class GraphKeyTypeTransform<VV, EV> extends ParameterizedBase
        implements Transform<
                Graph<LongValue, VV, EV>,
                Graph<?, VV, EV>,
    ...
    private ChoiceParameter type =
            new ChoiceParameter(this, "type")
    ...
    private final BooleanParameter disableTypeReversal =
            new BooleanParameter(this, "__disable_type_reversal");

    private final long vertexCount;

    /**
     * Create a key type transform. The type is configured by the command-line arguments but because
     * many types reduce the size of the vertex ID space the maximum extent must be set explicitly
     * by the input in order to perform bounds checking. An n-bit type can store up to 2^n - 1
     * vertex identifiers.
     *
    ...
    @Override
    public DataSet<TranslatableResult<?>> transformResult(
            final DataSet<TranslatableResult<?>> result) throws Exception {
        ...
        return result.flatMap(new TranslateResultIDs(translator))
                .returns(typeInfo)
        ...
        public ShortValue translate(LongValue value, ShortValue reuse) throws Exception {
            ...
            if (l < 0 || l >= MAX_VERTEX_COUNT) {
                throw new IllegalArgumentException(
                        "Cannot cast long value " + value + " to short.");
            }
    ...
    static class LongValueToUnsignedInt implements TranslateFunction<LongValue, Integer> {
        ...
        public Integer translate(LongValue value, Integer reuse) throws Exception {
            ...
            if (l < 0 || l >= MAX_VERTEX_COUNT) {
                throw new IllegalArgumentException(
                        "Cannot cast long value " + value + " to integer.");
            }
    ...
    static class LongValueToUnsignedFloatValue implements TranslateFunction<LongValue, FloatValue> {
        public static final long MAX_VERTEX_COUNT = 1L << 32;
        ...
        public FloatValue translate(LongValue value, FloatValue reuse) throws Exception {
            ...
            if (l < 0 || l >= MAX_VERTEX_COUNT) {
                throw new IllegalArgumentException(
                        "Cannot cast long value " + value + " to float.");
            }
    ...
    static class LongValueToUnsignedFloat implements TranslateFunction<LongValue, Float> {
        public static final long MAX_VERTEX_COUNT = 1L << 32;
    ...
    static class UnsignedByteValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                ByteValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
    ...
    static class UnsignedShortValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                ShortValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class UnsignedIntValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                IntValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class UnsignedIntToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                Integer value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class LongValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                LongValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class UnsignedFloatValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                FloatValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class DoubleValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                DoubleValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class DoubleToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                Double value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class StringValueToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                StringValue value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
    ...
    static class StringToLongValueWithProperHashCode
        ...
        @Override
        public LongValueWithProperHashCode translate(
                String value, LongValueWithProperHashCode reuse) throws Exception {
            if (reuse == null) {
                reuse = new LongValueWithProperHashCode();
            }
