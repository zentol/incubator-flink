...
/**
 * Provides the default data set used for the Label Propagation test program. If no parameters are
 * given to the program, the default edge data set is used.
 */
public class LabelPropagationData {
    ...
    public static final DataSet<Edge<Long, NullValue>> getDefaultEdgeDataSet(
