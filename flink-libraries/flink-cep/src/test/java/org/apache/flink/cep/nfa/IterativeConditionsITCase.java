...
public class IterativeConditionsITCase extends TestLogger {
    ...
    private List<List<Event>> testIterativeWithLoopingStarting(boolean eager) throws Exception {
        ...
        // for now, a pattern inherits its continuity property from the followedBy() or next(), and
        // the default
        // behavior (which is the one applied in the case that the pattern graph starts with such a
        // pattern)
