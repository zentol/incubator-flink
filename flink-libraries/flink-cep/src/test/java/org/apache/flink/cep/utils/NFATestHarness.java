...
public final class NFATestHarness {
    ...
    public Collection<Map<String, List<Event>>> consumeRecords(
            Collection<StreamRecord<Event>> inputEvents) throws Exception {
    ...
    public static class NFATestHarnessBuilderNFA extends NFATestHarnessBuilderBase {
        ...
        public NFATestHarness build() {
            return new NFATestHarness(
                    sharedBuffer, nfa, nfaState, afterMatchSkipStrategy, timerService);
        }
    }
    ...
    public abstract static class NFATestHarnessBuilderBase {
        ...
        public NFATestHarnessBuilderBase withAfterMatchSkipStrategy(
                AfterMatchSkipStrategy afterMatchSkipStrategy) {
            this.afterMatchSkipStrategy = afterMatchSkipStrategy;
            return this;
        }
