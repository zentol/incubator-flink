 ...
 * The main difference between this interface and {@link Comparable} is it is not require to follow
 * the usual contract between that {@link Comparable#compareTo(Object)} and {@link
...
public interface PriorityComparator<T> {
    ...
    PriorityComparator<? extends PriorityComparable<Object>> FOR_PRIORITY_COMPARABLE_OBJECTS =
            PriorityComparable::comparePriorityTo;
