...
public class InternalMetricScope implements MetricScope {
	...
	public InternalMetricScope(DelimiterProvider delimiterProvider, String[] scopeComponents, Supplier<Map<String, String>> variablesProvider) {
		...
		this.variables = new Map[delimiterProvider.getNumberReporters()];
		this.cachedIdentifierScopes = new String[delimiterProvider.getNumberReporters()];
	}

	@Override
	public Map<String, String> getAllVariables() {
		return getAllVariables(0, Collections.emptySet());
	}

	@Internal
	public Map<String, String> getAllVariables(int cachingIndex, Set<String> excludedVariables) {
		if (variables[cachingIndex] == null) {
			Map<String, String> tmpVariables = variablesProvider.get();
