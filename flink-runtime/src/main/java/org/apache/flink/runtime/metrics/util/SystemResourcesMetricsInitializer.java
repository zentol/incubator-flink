...
public class SystemResourcesMetricsInitializer {
    ...
    public static void instantiateSystemMetrics(MetricGroup metricGroup, Time probeInterval) {
        try {
            ...
            SystemResourcesCounter systemResourcesCounter =
                    new SystemResourcesCounter(probeInterval);
            ...
            instantiateMemoryMetrics(
                    system.addGroup("Memory"), hardwareAbstractionLayer.getMemory());
    ...
    private static void instantiateNetworkMetrics(
        ...
        for (int i = 0; i < usageCounter.getNetworkInterfaceNames().length; i++) {
            ...
            interfaceGroup.<Long, Gauge<Long>>gauge(
                    "ReceiveRate", () -> usageCounter.getReceiveRatePerInterface(interfaceNo));
            interfaceGroup.<Long, Gauge<Long>>gauge(
                    "SendRate", () -> usageCounter.getSendRatePerInterface(interfaceNo));
        }
    }
}
