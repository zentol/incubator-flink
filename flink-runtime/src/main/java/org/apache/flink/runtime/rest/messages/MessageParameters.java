...
public abstract class MessageParameters {
    ...
    /**
     * Returns the collection of {@link MessagePathParameter} that the request supports. The
     * collection should not be modifiable.
     *
    ...
    /**
     * Returns the collection of {@link MessageQueryParameter} that the request supports. The
     * collection should not be modifiable.
     *
