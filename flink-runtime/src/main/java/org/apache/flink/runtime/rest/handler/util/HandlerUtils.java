...
public class HandlerUtils {
    ...
    public static <P extends ResponseBody> CompletableFuture<Void> sendResponse(
        ...
        return sendResponse(channelHandlerContext, httpRequest, sw.toString(), statusCode, headers);
    }
    ...
    public static void transferFile(ChannelHandlerContext ctx, File file, HttpRequest httpRequest)
