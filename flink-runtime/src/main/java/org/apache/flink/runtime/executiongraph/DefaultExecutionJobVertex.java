...
/** Default {@link ExecutionJobVertex} implementation. */
public class DefaultExecutionJobVertex implements ExecutionJobVertex {
    ...
    private final DefaultExecutionVertex[] taskVertices;
    ...
    @VisibleForTesting
    public DefaultExecutionJobVertex(
        ...
        this.taskVertices = new DefaultExecutionVertex[numTaskVertices];
    ...
    public ExecutionState getAggregateState() {
        ...
        return ExecutionJobVertex.getAggregateJobVertexState(num, parallelism);
    }
