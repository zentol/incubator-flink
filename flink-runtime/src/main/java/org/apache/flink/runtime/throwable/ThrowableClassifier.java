...
public class ThrowableClassifier {
    ...
    /**
     * Classify the exceptions by extracting the {@link ThrowableType} from a potential {@link
     * ThrowableAnnotation}.
     *
     * @param cause the {@link Throwable} to classify.
     * @return The extracted {@link ThrowableType} or ThrowableType.RecoverableError if there is no
     *     such annotation.
     */
