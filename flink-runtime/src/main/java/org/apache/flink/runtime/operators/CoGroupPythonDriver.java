...
public class CoGroupPythonDriver<IT1, IT2, OT> implements PactDriver<CoGroupFunction<IT1, IT2, OT>, OT> {

	private static final Logger LOG = LoggerFactory.getLogger(CoGroupPythonDriver.class);
	...
	public void prepare() throws Exception {
		...
		if (config.getDriverStrategy() != DriverStrategy.CO_GROUP_PYTHON) {
