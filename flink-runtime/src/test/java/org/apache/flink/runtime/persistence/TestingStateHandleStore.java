...
public class TestingStateHandleStore<T extends Serializable>
    ...
    public static class Builder<T extends Serializable> {
        ...
        private BiFunctionWithException<String, T, RetrievableStateHandle<T>, Exception>
                addFunction = (ignore, state) -> null;
        private ThrowingConsumer<Tuple3<String, IntegerResourceVersion, T>, Exception>
                replaceConsumer = ignore -> {};
        ...
        public Builder<T> setAddFunction(
                BiFunctionWithException<String, T, RetrievableStateHandle<T>, Exception>
                        addFunction) {
            this.addFunction = addFunction;
            return this;
        }

        public Builder<T> setReplaceConsumer(
                ThrowingConsumer<Tuple3<String, IntegerResourceVersion, T>, Exception>
                        replaceConsumer) {
            this.replaceConsumer = replaceConsumer;
            return this;
        }

        public Builder<T> setExistsFunction(
                FunctionWithException<String, IntegerResourceVersion, Exception> existsFunction) {
            this.existsFunction = existsFunction;
            return this;
        }

        public Builder<T> setGetFunction(
                FunctionWithException<String, RetrievableStateHandle<T>, Exception> getFunction) {
            this.getFunction = getFunction;
            return this;
        }
        ...
        public Builder<T> setRemoveFunction(
                FunctionWithException<String, Boolean, Exception> removeFunction) {
            this.removeFunction = removeFunction;
            return this;
        }
        ...
        public Builder<T> setReleaseAllHandlesRunnable(
                RunnableWithException releaseAllHandlesRunnable) {
            this.releaseAllHandlesRunnable = releaseAllHandlesRunnable;
            return this;
        }
